...
* Execute DM package according dynamic prompt
DATA :
...
*ENDWHEN
*COMMIT
* USE standard program to test answer prompt file ie. UJD_TEST_PACKAGE

* MAKE SURE THAT ANSWER PROMPT is saved in a text file with TAB between %SELECTion% and FILEPATH
* /FILEPATH/USERID/TempFiles/FROM.TMP@@@SAVE@@@@@@EXPAND@@@|DIMENSION:TIME|2021_12|DIMENSION:VERSION|B2021V1|
*  terminated by |
