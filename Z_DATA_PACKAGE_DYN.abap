...
***********************************************************************
*---------------------------------------------------------------------------------------------------------
* BW - BPC Execute DM package according dynamic prompt
*
*---------------------------------------------------------------------------------------------------------
* Execute DM package for conversion according dynamic prompt                                                *
DATA :
...
*Loop on the internal table which contains the result of the previous select
    LOOP AT LT_PROMPT ASSIGNING <FS_PROMPT>.
      ...
      "If we delete the scope each time and there is a problem we do not know which scope has been already processed
      IF P_MSG = 'Y'.
        CLEAR LS_RESULT.
